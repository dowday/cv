...
\documentclass{cv-2020-soft-dev} % Use the custom resume.cls style
...
% \end{center}
\name{Oday Darwich} % Your name 


%\address{123 Pleasant Lane \\ City, State 12345} % Your secondary addess (optional)
\address{\faGithub{ github.com/zeeroday} \faLink{zeeroday.ch} \faEnvelope{ harrypotter@gmail.com}}
